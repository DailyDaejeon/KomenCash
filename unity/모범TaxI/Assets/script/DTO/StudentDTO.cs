...
public class StudentDTO
{
  ...
  public List<JSONNode> certificateList; //보유 자격증
  ...
  public StudentDTO(int id, string nickname, string password, string code, int balance, List<JSONNode> certificateList, JobDTO job, GroupDTO group, TeacherDTO teacher)
  {
    this.id = id;
    this.nickname = nickname;
    this.password = password;
  ...
  public void print()
  {
    ...
    string list = "";
    foreach (JSONNode key in certificateList)
    {
      list += key + " ";
    }
