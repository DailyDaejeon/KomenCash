<template lang="pug">
  <div class="k-progress">
    <div class="k-progress-outer">
      <div class="k-progress-outer-bg" :class="border ? 'k-progress-outer-bg-border' : ''" :style="getOuterStyle()"></div>
      <div class="k-progress-outer-line" :id="`k-progress-line-${idNow}`" :class="status ? 'k-progress-outer-line-' + status : ''" :style="getLineStyle()">
        <div class="k-progress-outer-line-active" v-if="active" :style="getActiveStyle()"></div>
      </div>
      <div class="k-progress-outer-cut" v-if="type === 'lump'" :style="getCutStyle()">
        <div v-for="item in items" :key="item" :style="getCutBarStyle()"></div>
      </div>
    </div>
    <div class="k-progress-text" v-if="showText">{{ content }}</div>
  </div>
</template>
